    ...
    try {
        ...
        try {
            ...
            try {
                ...
                logger.warn(`Failed to get balance after redeem: ${balanceError instanceof Error ? balanceError.message : String(balanceError)}`);
            ...
            logger.warn(`Failed to log balance: ${balanceLogError instanceof Error ? balanceLogError.message : String(balanceLogError)}`);
        }
